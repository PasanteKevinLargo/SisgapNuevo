...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    ListarRegistros: function ListarRegistros(page, buscar) {
      var me = this;
      var url = "/titulos/index?page=" + page + "&buscar=" + buscar;
    ...
    showModal: function showModal(accion, row) {
      ...
      switch (accion) {
        ...
        case 2:
          ...
          this.TITULO = row.TITULO, this.disabled = true;
          break;
                  ...
                  [
                    ...
                    _c(
                      "b-btn",
                      {
                        ...
                        on: {
                          click: function($event) {
                            return _vm.deleteRegistro(props.row.ID_TITULO)
                          }
                        }
                      },
