    ...
    showModal: function showModal(accion, row) {
      ...
      switch (accion) {
        ...
        case 2:
          ...
          this.NOMBRE_CARGO = row.NOMBRE_CARGO, this.DESCRIPCION_CARGO = row.DESCRIPCION_CARGO, this.TITULO_CARGO = row.TITULO_CARGO, this.ID_UNIDAD = row.ID_UNIDAD, this.disabled = true;
          break;
            ...
            [
              ...
              _c(
                ...
                [
                  _c(
                    "b-form-group",
                    { staticClass: "col-12", attrs: { label: "Nombres" } },
                    [
                      _c("b-input", {
                        ref: "descripcion",
                        attrs: {
                        ...
                        model: {
                          value: _vm.NOMBRE_CARGO,
                          callback: function($$v) {
                            _vm.NOMBRE_CARGO = $$v
                          },
                          expression: "NOMBRE_CARGO"
                        }
                      })
                    ],
                    1
                  ...
                  _c(
                    ...
                    [
                      _c("b-input", {
                        ...
                        model: {
                          value: _vm.DESCRIPCION_CARGO,
                          callback: function($$v) {
                            _vm.DESCRIPCION_CARGO = $$v
                          },
                          expression: "DESCRIPCION_CARGO"
                        }
                      })
                    ],
                    1
